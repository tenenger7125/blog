...
import { Button, ButtonGroup } from '@/components/shared/tiptap/tiptap-ui-primitive/button';
import { Card, CardBody, CardItemGroup } from '@/components/shared/tiptap/tiptap-ui-primitive/card';
import { Input, InputGroup } from '@/components/shared/tiptap/tiptap-ui-primitive/input';
import { Popover, PopoverContent, PopoverTrigger } from '@/components/shared/tiptap/tiptap-ui-primitive/popover';
      ...
      <CardBody
        ...
        <CardItemGroup orientation="horizontal">
          ...
          <ButtonGroup orientation="horizontal">
            <Button data-style="ghost" disabled={!url && !isActive} title="Apply link" type="button" onClick={setLink}>
