...
>(({ className, orientation = 'vertical', ...props }, ref) => (
  <div ref={ref} className={cn('tiptap-card-item-group', className)} data-orientation={orientation} {...props} />
));
CardItemGroup.displayName = 'CardItemGroup';

const CardGroupLabel = forwardRef<HTMLDivElement, React.ComponentProps<'div'>>(({ className, ...props }, ref) => (
  <div ref={ref} className={cn('tiptap-card-group-label', className)} {...props} />
));
